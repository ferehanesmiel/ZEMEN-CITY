  ...
  return (
    <div className="min-h-screen bg-black text-zinc-400 font-sans selection:bg-orange-500 selection:text-white">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row gap-12">
              ...
              <div className="w-full md:w-1/3 space-y-4">
                <div className="mb-8">
                  <h2 className="text-3xl font-black text-white mb-2 tracking-tight uppercase">App Launcher</h2>
                  <p className="text-sm text-zinc-500">
                    {user ? `Welcome back, ${profile?.name}. Access your connected apps.` : 'Login to access your shared wallet and identity.'}
                  </p>
                </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1 bg-orange-500/10 text-orange-500 text-[10px] font-bold uppercase tracking-widest rounded-full border border-orange-500/20">
                          {user ? 'Real-time Connected' : 'Demo Mode Active'}
                        </div>
                      </div>
        ...
        {/* Investor View Section */}
        <section id="investor" className="py-24 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase">Investor Showcase</h2>
              <p className="max-w-2xl mx-auto text-zinc-500">Real-time ecosystem metrics and growth projections for Zemen Digital City.</p>
            </div>
            <InvestorView />
          </div>
        </section>
